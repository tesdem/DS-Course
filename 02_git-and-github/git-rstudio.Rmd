...
that process using git and GitHub through RStudio (see the other [tutorial](https://github.com/datasciencelabs/2020/blob/master/git-and-github/git-command-line.Rmd) for using git and GitHub through the command line).
